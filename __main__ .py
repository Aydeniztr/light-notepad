...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Creating File Menu
    self.filemenu = Menu(self.menubar,fg="white",bg="#272727",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    # Creating Edit Menu
    self.editmenu = Menu(self.menubar,fg="white",bg="#272727",font=("calibri",10),activebackground="skyblue",tearoff=0)
