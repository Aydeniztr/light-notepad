...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Creating Titlebar 
    self.titlebar = Label(self.root,textvariable=self.title,fg="black",bg="#C0C0C0",font=("calibri",10),bd=0,relief=GROOVE)
    ...
    # Creating Text Area
    self.txtarea = Text(self.root,fg="white",bg="black",insertbackground="white",yscrollcommand=scrol_y.set,font=("mono",10),state="normal",relief=GROOVE)
