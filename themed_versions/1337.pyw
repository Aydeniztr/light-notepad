...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Creating Titlebar 
    self.titlebar = Label(self.root,textvariable=self.title,fg="white",bg="black",font=("calibri",10),bd=0,relief=GROOVE)
    ...
    # Creating Statusbar
    self.statusbar = Label(self.root,textvariable=self.status,fg="#66ff00",bg="black",font=("calibri",10),bd=2,relief=GROOVE)
    ...
    # Creating File Menu
    self.filemenu = Menu(self.menubar,fg="white",bg="black",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    # Creating Edit Menu
    self.editmenu = Menu(self.menubar,fg="white",bg="black",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    self.upload = Menu(self.menubar,fg="white",bg="black",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    # Creating Help Menu
    self.helpmenu = Menu(self.menubar,fg="white",bg="black",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    # Creating Text Area
    self.txtarea = Text(self.root,fg="#66ff00",bg="black",insertbackground="#66ff00",yscrollcommand=scrol_y.set,font=("mono",10),state="normal",relief=GROOVE)
