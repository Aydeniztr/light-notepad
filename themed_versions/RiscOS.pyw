...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Creating Titlebar 
    self.titlebar = Label(self.root,textvariable=self.title,fg="white",bg="#45152F",font=("calibri",10),bd=0,relief=GROOVE)
    ...
    # Creating Statusbar
    self.statusbar = Label(self.root,textvariable=self.status,fg="white",bg="#45152F",font=("calibri",10),bd=2,relief=GROOVE)
    ...
    # Creating File Menu
    self.filemenu = Menu(self.menubar,fg="white",bg="#45152F",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    # Creating Edit Menu
    self.editmenu = Menu(self.menubar,fg="white",bg="#45152F",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    self.upload = Menu(self.menubar,fg="white",bg="#45152F",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    # Creating Help Menu
    self.helpmenu = Menu(self.menubar,fg="white",bg="#45152F",font=("calibri",10),activebackground="skyblue",tearoff=0)
    ...
    # Creating Text Area
    self.txtarea = Text(self.root,fg="#363636",bg="#E6E6E6",yscrollcommand=scrol_y.set,font=("mono",10),state="normal",relief=GROOVE)
